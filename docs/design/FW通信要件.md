...
|  11   | `TAILSCALE-NODES` |    TCP     |     any      |     8006     |  `PVE-NODES`   | Proxmox API                                     |
|  20   | `TAILSCALE-NODES` |    UDP     |    41641     |     any      |      any       | Tailscale WireGuard 直接トンネル                |
|  30   | `TAILSCALE-NODES` |    UDP     |     any      |     3478     |      any       | Tailscale STUN                                  |
|  40   |  `DNS-SERVERS`    |    TCP     |     any      |     443      | `mirrors.almalinux.org` | AlmaLinux dnf リポジトリ               |
...
|  55   | `TAILSCALE-NODES` |    UDP     | 33434-33534  | `FW-DMZ-NODES` | traceroute |
