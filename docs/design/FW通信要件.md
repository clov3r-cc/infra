...
|  60   |   `DNS-SERVERS`   |   accept   |    TCP     |     any      |     443      |           `www.elrepo.org`           | ELRepo リポジトリ                               |
|  61   |   `DNS-SERVERS`   |   accept   |    TCP     |     any      |      80      |             `elrepo.org`             | ELRepo baseurl                                  |
|  62   |   `DNS-SERVERS`   |   accept   |    TCP     |     any      |      80      |         `mirrors.elrepo.org`         | ELRepo mirrorlist                               |
|  63   |   `DNS-SERVERS`   |   accept   |    TCP     |     any      |      80      |         `mirrors.coreix.net`         | ELRepo ミラー (Coreix)                          |
|  64   |   `DNS-SERVERS`   |   accept   |    TCP     |     any      |      80      |        `mirror.rackspace.com`        | ELRepo ミラー (Rackspace)                       |
|  65   |   `DNS-SERVERS`   |   accept   |    TCP     |     any      |      80      |       `linux-mirrors.fnal.gov`       | ELRepo ミラー (FNAL)                            |
|  66   |   `DNS-SERVERS`   |   accept   |    TCP     |     any      |     443      |      `ftp.yz.yamagata-u.ac.jp`       | MariaDB リポジトリ (山形大)                     |
